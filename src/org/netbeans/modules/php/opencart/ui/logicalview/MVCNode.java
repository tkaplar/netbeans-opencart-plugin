...
public class MVCNode extends FilterNode {
    ...
    public MVCNode(DataFolder folder, DataFilter filter, String name) {
    ...
    public Image getIcon(int type) {
        return ImageUtilities.mergeImages(super.getIcon(type), OpenCart.IMAGE_ICON_8.getImage(), 7, 7);
    }

    @Override
    public Image getOpenedIcon(int type) {
        return ImageUtilities.mergeImages(super.getOpenedIcon(type), OpenCart.IMAGE_ICON_8.getImage(), 7, 7);
    }
